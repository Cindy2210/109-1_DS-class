...
{
    //printf("ee\n");
    printf("%d(%p)(%p) \n", ((student*)node)->grade, ((student*)node)->link.left, ((student*)node)->link.right);
}
...
*/
    ...
    int flag = 1;
/*
    treeEqual(root, root2, alpha, &flag, out);
    if( flag == 1 )
    {
...
/*
        deleteNode((void*)(&num[2]), &root, alpha, out);
        inOrder(root, out);
        printf("\n#1--5 \n\n");

        deleteNode((void*)(&num[6]), &root, alpha, out);
        inOrder(root, out);
        printf("\n#2--9 \n\n");

        deleteNode((void*)(&num[3]), &root, alpha, out);
        inOrder(root, out);
        printf("\n#3--6 \n\n");

        deleteNode((void*)(&num[4]), &root, alpha, out);
        inOrder(root, out);
        printf("\n#4--3 \n\n");

        deleteNode((void*)(&num[1]), &root, alpha, out);
        inOrder(root, out);
        printf("\n#5--1 \n\n");

        deleteNode((void*)(&num[8]), &root, alpha, out);
        inOrder(root, out);
        printf("\n#6--8 \n\n");

        deleteNode((void*)(&num[7]), &root, alpha, out);
        inOrder(root, out);
        printf("\n#7--7 \n\n");

        deleteNode((void*)(&num[5]), &root, alpha, out);
        inOrder(root, out);
        printf("\n#8--4\n\n");
*/
    /*
